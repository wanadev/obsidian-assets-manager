 ...
 *
 * @class obsidian-assets-manager.lib.obsidian-assets-manager
 * @constructor
 */
var ObsidianAssetsManager = Class.$extend({
    ...
    addAssetFromUrl: function(url, options) {
        options = options || {};
        options.id = options.id || "url:" + url;

        var id = this.addAsset(options);
        this.$data.assetList[id].as.blobUrl = url;
        return AssetsConverter._blobUrlToBuffer(this.$data.assetList[id])
            .then(function(asset) {
    ...
    importAssetPackageFromUrl: function(url) {
        var _this = this;
        var packAsset = { as: { blobUrl: url } };
        return AssetsConverter._blobUrlToBuffer(packAsset)
    ...
    assetExists: function(id) {
        return this.$data.assetList[id] !== undefined;
    },
    ...
    assetPackageExists: function(packName) {
        return this.$data.packList[packName] !== undefined;
    },
    ...
    removeAssetPackage: function(packName) {
        // @fixme Remove all from assetList if any
